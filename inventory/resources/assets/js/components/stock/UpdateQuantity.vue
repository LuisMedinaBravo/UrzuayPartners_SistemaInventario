			...
			<div class="modal-dialog modal-sm" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h4 class="modal-title" id="defaultModalLabel">Actualizar cantidad de: {{ product.product_name }}</h4>
					</div>
					<div class="modal-body">
						...
						<form>
							<div class="row">
								<!-- <div class="col-md-12"> <div class="input-group"> <span class="input-group-addon"> <i class="material-icons">palette</i> </span> <div class="form-line"> <select class="form-control" v-model="product.state"> <option value="+">+</option> </select> </div> </div> </div>	 -->
								<div class="col-md-12">
									...
									<p style="text-align: center; font-size: 12px; margin-top: -20px;">Añadir/Quitar</p>
								</div>
								...
								<div class="col-md-12">
									<div class="input-group">
										...
										<div class="form-line">
											<input type="number" class="form-control date" placeholder="Cantidad para actualizar" v-model="product.new_qty" min="0">
										</div>
									</div>
									<p style="text-align: center; font-size: 12px; margin-top: -20px;">Cantidad de consumo</p>
								</div>
							</div>
						</form>
					</div>
