      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title" id="defaultModalLabel">Actualizar información del proveedor</h4>
          </div>
      ...
      axios
        ...
        .then((response) => {
          this.vendor = {
            ...
            soporte_nombre: response.data.soporte_nombre,
            soporte_correo: response.data.soporte_correo,
            soporte_phone: response.data.soporte_phone,
          };
        });
    },
    updateVendor(id) {
